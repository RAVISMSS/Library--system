...
/*==================== POPULATING TABLES ======================*/
	...
	INSERT INTO tbl_borrower
		...
		VALUES
		('Ravish Manohar','Sail city New pundag','1111111111'),
		('Suraj kumar','Hari om Tower Lalpur','2222222222'),
		('Rhitam Nayek',' Main Street','3333333333'),
		('Omesh Lal Das','2212 Green Avenue','4444444444'),
		('Shuvam Das','Suprabhat apartement','5555555555'),
		('Ribhu nirek','Himadri resdidency','6666666666'),
		('Aditya singh','Ziska homes','7777777777'),
		('Priyanshu raj','ratu rode chowke',8888888888');
	...
	INSERT INTO tbl_book_loans
		...
		('12','2','105','12/12/22','1/12/23'),
		('10','2','105','12/12/22','1/12/23'),
		...
		('19','3','102','12/12/23','1/12/23'),
		('20','4','103','1/3/23','2/3/23'),
		('1','4','102','1/12/23','2/12/23'),
		('3','4','107','1/3/23','2/3/23'),
		('18','4','107','1/3/23','2/3/23'),
		('12','4','102','1/4/23','2/4/23'),
		('11','4','103','1/15/23','2/15/23'),
		('9','4','103','1/15/23','2/15/23'),
		('7','4','107','1/1/23','2/2/23'),
		('4','4','103','1/1/23','2/2/23'),
		('1','4','103','2/2/17','3/2/23'),
		('20','4','103','1/3/23','2/3/23'),
		('1','4','102','1/12/23','2/12/23'),
		('3','4','107','1/13/23','2/13/23'),
		('18','4','107','1/13/23','2/13/23'),
		('12','4','102','1/14/23','2/14/23'),
		('11','4','103','1/15/23','2/15/23'),
		('9','4','103','1/15/23','2/15/23'),
		('7','4','107','1/19/23','2/19/23'),
		('4','4','103','1/19/23','2/19/23'),
		('1','4','103','1/22/23','2/22/23');
